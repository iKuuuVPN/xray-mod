...
type ServerConfig struct {
	...
	// Use Intel(R) IPSec Multi-Buffer library for SS AEAD AES-GCM (aes-128-gcm / aes-256-gcm) user matching.
	UseIpsecmb    bool `protobuf:"varint,3,opt,name=use_ipsecmb,json=useIpsecmb,proto3" json:"use_ipsecmb,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ServerConfig) GetUseIpsecmb() bool {
	if x != nil {
		return x.UseIpsecmb
	}
	return false
...
const file_proxy_shadowsocks_config_proto_rawDesc = "" +
	...
	"cipherType\x12\x19\n" +
	"\biv_check\x18\x03 \x01(\bR\aivCheck\"\x95\x01\n" +
	"\fServerConfig\x120\n" +
	"\x05users\x18\x01 \x03(\v2\x1a.xray.common.protocol.UserR\x05users\x122\n" +
	"\anetwork\x18\x02 \x03(\x0e2\x18.xray.common.net.NetworkR\anetwork\x12\x1f\n" +
	"\vuse_ipsecmb\x18\x03 \x01(\bR\n" +
	"useIpsecmb\"L\n" +
	"\fClientConfig\x12<\n" +
