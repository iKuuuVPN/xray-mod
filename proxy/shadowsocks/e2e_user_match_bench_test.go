...
func benchmarkSSAEAD_AES128GCM_E2E_UserMatch_100k(b *testing.B, useIPSecMB bool) {
	const users = 100_000
	const seed = 20260224
...
func BenchmarkSSAEAD_AES128GCM_E2E_UserMatch_100k_Random_Original(b *testing.B) {
	benchmarkSSAEAD_AES128GCM_E2E_UserMatch_100k(b, false)
}

func BenchmarkSSAEAD_AES128GCM_E2E_UserMatch_100k_Random_IPsecMB(b *testing.B) {
	benchmarkSSAEAD_AES128GCM_E2E_UserMatch_100k(b, true)
}
